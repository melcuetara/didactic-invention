...
<body>
    ...
    <div class="container pt-5" id="border">
        <div class="container p-5 my-5 border bg-white">
            <h3 class="mb-3">Meal Plan List</h3>
            <s:iterator value="plans" status="counter">
                <div class="container my-3">
                    ...
                    <div class="card">
                        ...
                        <s:if test="current_calories > max_calories">
                            <div class="card-body" id="error">
                                Calories: <s:property value="current_calories" /> / <s:property value="max_calories" />
                            </div>
                        </s:if>
                        <s:else>
                            <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <s:url var="url" action="viewPlan" namespace="/example" >
                            <s:param name="planId"><s:property value="plan_id" /></s:param>
                        </s:url>
                        <s:a href="%{url}" theme="simple" cssClass="link-primary">
                            View
                        </s:a>
                    </div>
                </div>
